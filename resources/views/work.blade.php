            ...
            <div class="col-sm-10 col-12">
                <div class="col-11 p-2 col-sm-12 p-sm-0">
                    <p class="text-work pb-3">
                        Step into my creative world, where pixels and ideas dance in harmony. This is my portfolio — a
                        collection of stories told through design. From pixels to paper, each piece is a brushstroke of
                        innovation and a testament to the art of user experience. Explore, discover, and let the designs
                        whisper their tales.
                    </p>
                </div>
            </div>
